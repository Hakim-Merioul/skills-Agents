/**
 * html2pptx — Convert an HTML slide into a pptxgenjs slide with positioned elements.
 *
 * USAGE:
 ...
 *   - Supports text, images, shapes, bullet lists
 *   - Extracts placeholder elements (class="placeholder") with positions
 *   - Handles CSS gradients, borders, margins
 *
 * VALIDATION:
 *   - Uses body width/height from HTML for viewport sizing
 *   - Throws if HTML dimensions don't match presentation layout
 *   - Throws if content overflows body
 *
 * RETURNS:
